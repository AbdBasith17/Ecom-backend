...
class AddToWishlistAPIView(APIView):
    ...
    def post(self, request):
        ...
        item, created = WishlistItems.objects.get_or_create(wishlist=wishlist, product=product)

        # CHANGE: Always return the serialized item, even if it wasn't "created" fresh.
        # This keeps the Frontend state happy.
