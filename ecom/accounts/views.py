...
class GoogleSignInView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            # Use update_or_create to ensure the name is captured even if 
            # the user existed previously without a name.
            ...
            # Set Cookies (Ensure secure=True in production!)
            cookie_settings = {
                "httponly": True,
                "samesite": "Lax",
            ...
            response.set_cookie(
                ...
                max_age=60*15, **cookie_settings
            )
            response.set_cookie(
                "refresh", str(refresh), 
                max_age=60*60*24*7, **cookie_settings
            )
